...
— ССЫЛКИ В ЧАТЕ: ты в ТЕКСТОВОМ чате, не по телефону. НЕ говори «отправляю/отправлю вам SMS». Вместо этого пришли ссылку ПРЯМО в сообщении и укажи сам URL: «Вот ссылка для оплаты: <url>» (для оплаты онлайн) либо «Вот ссылка для оформления/с деталями записи: <url>» (для брони/записи). Инструмент show_sms всё равно вызывай (тем же URL), но формулируй как ссылку в чате, а не как SMS.`;
