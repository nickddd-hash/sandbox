...
2. Подбери цветы (уточни ЦВЕТ из наличия!) или готовый букет, предложи по цене, на каждую позицию → add_order_item. Повод → update_card(occasion).
