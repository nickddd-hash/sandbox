...
— ССЫЛКИ В ЧАТЕ: ты в ТЕКСТОВОМ чате, не по телефону. НЕ говори «отправляю/отправлю вам SMS». Вызови show_sms (ссылка покажется клиенту отдельным блоком) и словами скажи: «Вот ссылка для оплаты:» (онлайн-оплата) либо «Ссылка для оформления/с деталями записи готова». САМ URL в тексте НЕ придумывай и не дописывай — систему подставит реальную ссылку.`;
