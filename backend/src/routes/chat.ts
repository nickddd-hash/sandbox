...
ДАТЫ: Если клиент называет только число без месяца (например «по 20», «до 25-го»), возьми месяц из уже названной даты начала. Пример: «с 15 июля» → «по 20» = 20 июля. В update_card ВСЕГДА формат ДД.ММ.ГГГГ, например 15.06.2025.
