...
const meat: NicheConfig = {
  ...
  script: [
    ...
    { at: 14200, say: { from: 'agent', text: 'Итого 9 000 ₽, доставка бесплатно. Как удобнее оплатить — по карте или выставить счёт?' } },
    { at: 15600, say: { from: 'user', text: 'По счёту, мы юрлицо.' } },
    { at: 16100, tool: { name: 'update_card', args: { field: 'payment', value: 'По счёту (юрлицо)' } } },
    { at: 16600, say: { from: 'agent', text: 'Хорошо! Загрузите реквизиты компании на странице — счёт сформируется автоматически и попадёт в 1С. SMS с деталями заказа отправляю сейчас.' } },
    { at: 17400, tool: { name: 'show_sms', args: { text: 'Заказ Meat Foods на 9 000 ₽, доставка завтра к 10:00:', link: 'meatfoods.ru/order/3471' } } },
    { at: 18200, tool: { name: 'lead_score', args: { score: 90, sentiment: 'горячий' } } },
    { at: 19000, tool: { name: 'set_summary', args: { text: 'Ресторан «Прайм» (Андрей): филе грудки 10 кг + заготовка для шаурмы (курица) 15 кг = 9 000 ₽. Оплата по счёту (юрлицо). Доставка завтра к 10:00, Москва, Тверская 5. SMS отправлено.' } } },
    { at: 19800, say: { from: 'agent', text: 'Заказ принят! Доставим завтра к 10:00. Спасибо, что выбрали Meat Foods.' } },
  ],
};
...
const flowers: NicheConfig = {
  ...
  script: [
    ...
    { at: 12800, say: { from: 'agent', text: 'Оплата картой онлайн или наличными курьеру?' } },
    { at: 14000, say: { from: 'user', text: 'Онлайн.' } },
    { at: 14300, tool: { name: 'update_card', args: { field: 'payment', value: 'Онлайн (карта)' } } },
    { at: 14800, say: { from: 'agent', text: 'Отлично, оформляю заказ…' } },
    { at: 15600, tool: { name: 'place_order', args: { deliveryTime: 'сегодня к 17:00' } } },
    { at: 16200, say: { from: 'agent', text: 'Готово! Букет из 25 роз с оформлением — 3750 ₽, доставка бесплатно. Отправляю ссылку на оплату в SMS.' } },
    { at: 16800, tool: { name: 'show_sms', args: { text: 'Заказ «Флёр»: букет из 25 роз, 3750 ₽, доставка сегодня к 17:00:', link: 'fleur.ru/order/2231' } } },
    { at: 17600, tool: { name: 'lead_score', args: { score: 86, sentiment: 'позитивный' } } },
    { at: 18400, tool: { name: 'set_summary', args: { text: 'Олег — букет из 25 красных роз + оформление (3750 ₽) на день рождения, оплата онлайн картой, доставка сегодня к 17:00, ул. Пушкина 12-5. Отправлено SMS с ссылкой на оплату.' } } },
    { at: 19200, say: { from: 'agent', text: 'Заказ принят! Доставим сегодня к 17:00. Спасибо, что выбрали «Флёр»!' } },
  ],
};
...
const realty: NicheConfig = {
  ...
  crmView: 'calendar',
  script: [
    { at: 600, say: { from: 'agent', text: 'Агентство недвижимости «Новосёл», риэлтор Светлана. Здравствуйте! Вам жилая или коммерческая недвижимость?' } },
    { at: 2200, say: { from: 'user', text: 'Жилая. Ищу двушку в центре, бюджет до 9 миллионов.' } },
